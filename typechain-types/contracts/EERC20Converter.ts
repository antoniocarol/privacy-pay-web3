...
export interface EERC20ConverterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "nullifiers"
      | "privateTransfer"
...
export interface EERC20Converter extends BaseContract {
  connect(runner?: ContractRunner | null): EERC20Converter;
  waitForDeployment(): Promise<this>;

  interface: EERC20ConverterInterface;
